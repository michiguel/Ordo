...
{'s',	"simulations",	required_argument,	"NUM",		0,	"perform # simulations to calculate errors"},
{'e',	"error-matrix",	required_argument,	"FILE",		0,	"save an error matrix, if -s was used"},
{'C',	"cfs-matrix",	required_argument,	"FILE",		0,	"save a matrix (.csv) with confidence for superiority (-s was used)"},
{'J',	"cfs-show",		no_argument,		NULL,		0,	"add an output column with confidence for superiority (next player)"},
{'F',	"confidence",	required_argument,	"NUM",		0,	"confidence (%) to estimate error margins. Default=95.0"},
	
{'X',	"ignore-draws",	no_argument,		NULL,		0,	"ignore draws"},
...
{'Y',	"synonyms",		required_argument,	"FILE",		0,	"name synonyms (csv format). Each line: main,syn1,syn2 etc."},
