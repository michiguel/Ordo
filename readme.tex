...
\subsubsection*{Loose anchors with prior information}
...
That means that the value will be 68\% of the time between +- the uncertainty value provided.
...
For instance, if one line of the file provided with the switch -y contains
...
\subsubsection*{Relative anchors}
