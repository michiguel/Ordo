...
Ordo can use several pgn input files at the same time (up to 1024 files).
It is not needed to combine them beforehand.
To do list, each file could be listed after the switch \swtch{-}\swtch{-} like this
