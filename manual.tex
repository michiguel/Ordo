...
The switch \swtch{-N} provides the ability to control the precision displayed for the ratings.
For instance, \swtch{-N2} will output ratings with two decimals.
If an extra parameter is provided separated by comma, it will control the number of decimals for the score percentage.
