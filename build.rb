...
$OPT='-O3'
$LIB='-lm'
$SRC='myopt/myopt.c mystr.c proginfo.c pgnget.c randfast.c gauss.c groups.c cegt.c indiv.c encount.c ratingb.c rating.c xpect.c csv.c fit1d.c mymem.c report.c relprior.c relpman.c main.c'
$EXE='-o ' + $NAME
