...
SRC = myopt/myopt.c mystr.c proginfo.c pgnget.c randfast.c gauss.c groups.c csv.c main.c
DEPS = boolean.h  datatype.h  gauss.h  groups.h  mystr.h  mytypes.h  ordolim.h  pgnget.h  proginfo.h  progname.h  randfast.h  version.h myopt/myopt.h csv.h
OBJ = myopt/myopt.o mystr.o proginfo.o pgnget.o randfast.o gauss.o groups.o csv.o main.o
